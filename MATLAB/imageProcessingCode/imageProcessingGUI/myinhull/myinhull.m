function in = myinhull(testpts,xyz)
...
switch p
  case 2
    ...
    if sum(degenflag)>0
        printf('inhull:degeneracy %d degenerate edges identified in the convex hull', sum(degenflag))
  ...
  otherwise
    ...
    if sum(degenflag)>0
        printf('inhull:degeneracy %d degenerate simplexes identified in the convex hull', sum(degenflag))
