function [allImgs, reorderedImgs, accurateImgs, nSweeps] = EM_ECG_matching(handles)
...
allImgs = handles.allImages;

% get EM readings
EMreadingTime = handles.finputs_.EM_sample_time;
EMreading = handles.finputs_.T_BBfixed_CT(:,:,:);
