function [CdZeroed] = interpolateSlices(stitch, cropMask, doPadding)
% INTERPOLATESLICES: A part of ICEbot_imgProcGUI_v1
...
volume = interpolateAvg_v3(observations, 0.9, 1);
